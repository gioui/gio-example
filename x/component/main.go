...
import (
	...
	"gioui.org/example/x/component/pages/about"
	"gioui.org/example/x/component/pages/appbar"
	"gioui.org/example/x/component/pages/menu"
	"gioui.org/example/x/component/pages/navdrawer"
	"gioui.org/example/x/component/pages/textfield"
